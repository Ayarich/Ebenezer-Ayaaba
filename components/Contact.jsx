          ...
          <div
            ...
            <div className="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="mx-auto mb-12 text-center lg:mb-0">
                ...
                <h6 className="font-medium">Ghana</h6>
              </div>
              <div className="mx-auto mb-12 text-center lg:mb-0">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                  stroke="currentColor" className="mx-auto mb-6 h-8 w-8 text-primary dark:text-primary-400">
                ...
                <h6 className="font-medium">Kumasi</h6>
              </div>
              <div className="mx-auto mb-6 text-center md:mb-0">
                ...
                <h6 className="font-medium">+233 55 176 9359</h6>
              </div>
              <div className="mx-auto text-center">
                ...
                <h6 className="font-medium">eben.ayaaba@gmail.com</h6>
              </div>
            </div>
